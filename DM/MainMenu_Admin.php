...
<body>
    ...
    <div id="side-menu" class="side-menu">
        ...
        <br><br><br>
        <a href="MainMenu_Admin.php">Home</a>
    ...
    <div class="section">
        <h3>Recommendations
            <button onclick="addNewItem('recommendations')" class="addItem-btn">+ Add new information</button>
        </h3>    
    ...
    <div class="section">
        <h3>What's new!
            <button onclick="addNewItem('new')" class="addItem-btn">+ Add new information</button>
        </h3>
        ...
        function createCard(section, item) {
            ...
            card.innerHTML = `
                <div style="display: flex; justify-content: space-between; align-items: center;">
                    <h4>${item.title}</h4>
                    <span class="favorite-btn" onclick="toggleFavorite(${item.id}, this)">
                        ${isFavorite ? '⭐' : '☆'}
                    </span>
                </div>
                <img src="${item.image}" style="width:100%; height:auto; border-radius:10px;">
                <p>${item.description}</p>
                <button onclick="editItem(this, '${section}')">✏️ Edit</button>
                <button onclick="deleteItem(this, '${section}')">🗑️ Delete</button>
            `;
